...
The `window.tolstoyWidget.postMessage` function allows you to send messages to the Tolstoy widget, enabling you to trigger specific actions or events.

### "tolstoy_reject_cookie_policy"
