---
title: "Cookie Consent and Default Policy"
...
### Set Tolstoy Conset programmatically

You can programmatically accept or reject cookies after the page has loaded — for example, when a visitor clicks buttons in your cookie banner. Use the public messaging API:
